%% tcme_plot_multcompare
% 
% Produces the Tukey HSD multiple comparison plots for a four factors, 
...
%% Synopsis
%
%   [] = tcme_plot_multcompare(anovaStats, measureID, trackID, lugType)
%  
% *Parameters*
%
...
function [] = tcme_plot_multcompare(anovaStats, trackID, lugType)
    ...
    currentFigure = figure('Visible', 'off');
       ...
       currentFigure.Children.XLabel.String = 'Normalized Measure Marginal Mean';
       ...
       figureID = EXPERIMENT.pattern.identifier.figure.multcompare('tcme', lugType, 'stop', 'tcme', trackID);
    ...
    currentFigure = figure('Visible', 'off');
       ...
       figureID = EXPERIMENT.pattern.identifier.figure.multcompare('tcme', lugType, lugType, 'tcme', trackID);
    ...
    currentFigure = figure('Visible', 'off');
       ...
       figureID = EXPERIMENT.pattern.identifier.figure.multcompare('tcme', lugType, 'model', 'tcme', trackID);
