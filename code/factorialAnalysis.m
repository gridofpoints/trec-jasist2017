%% factorialAnalysis
% 
% Performs the requested factorial analysis on the considered experimental
% collections.

%% Synopsis
%
%   [] = factorialAnalysis(trackID, tag, startMeasure, endMeasure)
%  
%
% *Parameters*
%
...
function [] = factorialAnalysis(trackID, tag, startMeasure, endMeasure)
